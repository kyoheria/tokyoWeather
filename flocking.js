...
function Boid(x,y) {
  ...
  this.r = 3.0;
  this.maxspeed = windspeed;    // Maximum speed
...
Boid.prototype.borders = function() {
  ...
  if (this.position.y < -this.r)  this.position.y = height-200+this.r;
  if (this.position.x > width +this.r) this.position.x = -this.r;
  if (this.position.y > height-200+this.r) this.position.y = -this.r;
}
